...
class CustomTextFieldState extends Equatable {
  ...
  const CustomTextFieldState({required this.customTextFieldState});

  CustomTextFieldState copyWith({
    ViewData<bool>? customTextFieldState,
  }) {
    return CustomTextFieldState(customTextFieldState: customTextFieldState ?? this.customTextFieldState);
  }
